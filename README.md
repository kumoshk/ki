...
To install do `git clone https://github.com/kumoshk/ki; cd ki; sudo python3 ki -u; ki --xload xscheme.ki`, and follow the prompts (omit `sudo` if you're on Termux or want a local installation).
